// JanSetu Chat Application with Independent Graph Visualizations
...
var chatApp = {
    // Configuration
    apiBase: APP_CONFIG.baseURL || window.location.origin,
    userId: null,
    sessionId: null,
    isProcessing: false,
    ...
    init: function() {
        console.log('🔧 Initializing JanSetu chat with expandable cards and independent graph visualization...');
    ...
    initializeSession: function() {
        var existingUserId = sessionStorage.getItem('janSetu_user_id');
        var existingSessionId = sessionStorage.getItem('janSetu_session_id');
        ...
        if (existingUserId && existingSessionId) {
            ...
            sessionStorage.setItem('janSetu_user_id', this.userId);
            sessionStorage.setItem('janSetu_session_id', this.sessionId);
